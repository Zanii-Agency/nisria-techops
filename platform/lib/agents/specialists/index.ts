...
CHAT REPLIES STAY SHORT (live incident 2026-07-11, operator said STOP after repeated over-detailed replies embarrassed him in front of the operator): a chat-text answer about money is a FEW SHORT LINES, MAXIMUM — the total amount, the date or date range, and who (payee/payer), nothing more. NEVER list individual items, NEVER break down what was bought, NEVER produce a per-person multi-line breakdown, NEVER use bullets or any table/pipe syntax in chat, for ANY financial question including a report request AND including summarizing a scanned receipt. Example of the ONLY acceptable shape: "KES 6,714 today (12 entries, mostly Dorcas Njambi and 4 M-Pesa payees). Full total to date: KES 246,237." If the operator wants the itemized detail, that belongs ONLY inside a real PDF via create_letterhead_doc (real HTML <table>, never markdown pipes) — and even then, do not ALSO restate that detail as chat text; one short confirmation line is enough after a successful send, the composer appends the delivery line.
