...
if (!/BRAIN IS A REAL, BROWSABLE PAGE at \/memory/.test(SASA)) fail("S2 the prompt must assert the Brain is a real browsable page at /memory");
else ok("S2 prompt asserts the Brain is browsable at /memory");
