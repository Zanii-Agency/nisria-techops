      ...
      if (effectiveYes) {
        ...
        for (const p of pendToCommit) {
          ...
          if (p.kind === "record_payment") {
            ...
            const CONFIRMABLE_TOOLS = new Set(["log_payout", "delete_event", "delete_contact", "delete_case", "delete_document", "delete_payment", "delete_task", "merge_contact", "merge_beneficiary", "merge_case"]);
