...
// The two summary cards in the hero (this-week count + next-up) restated data
// the grid below already shows, AND the same data the home CalendarWidget
// already renders. Founder flagged it (portal-fix shot 4). The grid is the
// load-bearing surface; the hero is now just title + chrome.
